...
import com.live.tv.mvp.presenter.shop.HotGoodsListPresenter;
...
public class hotGoodsListFragment extends BaseFragment<IHotGoosListView, HotGoodsListPresenter> implements IHotGoosListView {
    ...
    public static hotGoodsListFragment newInstance(String class_uuid) {
        Bundle args = new Bundle();
        hotGoodsListFragment fragment = new hotGoodsListFragment();
    ...
    @Override
    public void initUI() {
        bg_one.setVisibility(View.GONE);
    ...
    @Override
    public HotGoodsListPresenter createPresenter() {
        return new HotGoodsListPresenter(getApp());
    }
