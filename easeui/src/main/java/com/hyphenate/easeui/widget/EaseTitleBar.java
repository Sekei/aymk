...
public class EaseTitleBar extends RelativeLayout{
    ...
    protected RelativeLayout right_layout_text;
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        right_layout_text = (RelativeLayout) findViewById(R.id.right_layout_text);
    ...
    public void setRightLayoutClickListener(OnClickListener listener){
        right_layout_text.setOnClickListener(listener);
    }

        public void setRight_textClickListener(OnClickListener listener){
            right_layout_text.setOnClickListener(listener);
    }
    ...
    public void setRight_textVisibility(int visibility){
        right_layout_text.setVisibility(visibility);
    }
