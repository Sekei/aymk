...
public class UpdateLoginPwdpresenter extends BasePresenter<IUpdateLoginPwdView> {
    public UpdateLoginPwdpresenter(App app) {
        super(app);
    }

    //注册
    public void UpdateLoginPwd(Map<String, String> parmer) {
        getAppComponent().getAPIService()
                .UpdateLoginPwd(parmer)
                ...
                .subscribe(new Observer<HttpResult<String>>() {
                    ...
                    public void onNext(HttpResult<String> userBeanHttpResult) {
                        if (userBeanHttpResult != null) {
                            if (isViewAttached()) {
                                getView().onUpdateLoginPwd(userBeanHttpResult.getData());
                            }
                        }
                    }
                });
