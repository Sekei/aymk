...
public class AssessmentDoctorAdapter extends BaseQuickAdapter< String, BaseViewHolder> {


    public AssessmentDoctorAdapter(List<String> data) {
        super(R.layout.item_assessment_doctor_img, data);
    }
