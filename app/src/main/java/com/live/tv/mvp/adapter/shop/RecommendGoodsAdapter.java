...
public class RecommendGoodsAdapter extends RecyclerArrayAdapter<GoodsBean> {
    public RecommendGoodsAdapter(Context context, List<GoodsBean> objects) {
    ...
    public class ViewHolder extends BaseViewHolder<GoodsBean> {
        ...
        public ViewHolder(ViewGroup parent) {
            super(parent, R.layout.item_shop_recommend_goods);
            img= $(R.id.img);
            name= $(R.id.name);
            price= $(R.id.price);
        }
