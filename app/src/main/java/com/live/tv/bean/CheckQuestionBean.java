...
public class CheckQuestionBean {
     ...
     * done_ques_num : 12
     * sum_ques_num : 64
     * question_ids : 23,47,64,54,34,5,18,43,31,59,9,9
     * test_result :
     * done_ques_time :
     * done_factors_time :
     * is_done_ques : 0
     ...
     * plan_title :
     * is_sure_factors : 0
     * create_time : 2018-01-23 11:33:29
     * update_time : 2018-01-23 11:45:15
     * is_delete : 0
     * leadFactorsBeans : []
     * dreportBeans : []
     * leadResultBeans : []
    ...
    private List<?> leadFactorsBeans;
    private List<?> dreportBeans;
    private List<?> leadResultBeans;
    ...
    public List<?> getLeadFactorsBeans() {
        return leadFactorsBeans;
    }

    public void setLeadFactorsBeans(List<?> leadFactorsBeans) {
        this.leadFactorsBeans = leadFactorsBeans;
    }

    public List<?> getDreportBeans() {
        return dreportBeans;
    }

    public void setDreportBeans(List<?> dreportBeans) {
        this.dreportBeans = dreportBeans;
    }

    public List<?> getLeadResultBeans() {
        return leadResultBeans;
    }

    public void setLeadResultBeans(List<?> leadResultBeans) {
