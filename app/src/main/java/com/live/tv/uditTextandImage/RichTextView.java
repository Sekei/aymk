...
//                            .start(activity);
    ...
    public void addImageViewAtIndex(final int index, final String imagePath) {
        ...
        final com.live.tv.uditTextandImage.DataImageView imageView = (DataImageView) imageLayout.findViewById(R.id.edit_imageView);
                   ...
                   .into(new SimpleTarget<GlideDrawable>() {
                       ...
                       public void onResourceReady(GlideDrawable resource, GlideAnimation<? super GlideDrawable> glideAnimation) {
                           ...
                           if (rtImageHeight > 0) {
                               ...
                               imageHeight = allLayout.getWidth() * resource.getIntrinsicHeight() / resource.getIntrinsicWidth();
                           }
                           RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(
                                   LayoutParams.MATCH_PARENT, imageHeight);//固定图片高度，记得设置裁剪剧中
                           lp.bottomMargin = rtImageBottom;
