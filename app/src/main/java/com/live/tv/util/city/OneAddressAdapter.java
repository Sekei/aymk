...
public class OneAddressAdapter extends RecyclerArrayAdapter<ProvinceBean> {
    ...
    public OneAddressAdapter(Context context, List<ProvinceBean> objects) {
    ...
    class CategoryHolder extends BaseViewHolder<ProvinceBean> {
