...
import com.live.tv.mvp.adapter.mine.CollectionDoctorAdapter;
...
public class AllCollectionFragment extends BaseFragment<ICollectionView,CollectionListPresenter>implements ICollectionView {
    ...
    private CollectionDoctorAdapter  mAdapter;
    ...
    public void initUI() {
        ...
        mAdapter = new CollectionDoctorAdapter(context, list);
        ...
        mAdapter.setOnclick(new CollectionDoctorAdapter.onclick() {
            @Override
        ...
        mAdapter.setOnItemClickListener(new RecyclerArrayAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                startDoctorDetailFragment(merchantsBean.getDoctor_id());
