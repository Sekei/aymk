...
public class MoreSearchDoctorFragment extends BaseFragment<IMoreSearchDoctorView,MoreSearchDoctorPresenter>implements IMoreSearchDoctorView {
    ...
    public static MoreSearchDoctorFragment newInstance(String keyWord) {
        Bundle args = new Bundle();
        MoreSearchDoctorFragment fragment = new MoreSearchDoctorFragment();
