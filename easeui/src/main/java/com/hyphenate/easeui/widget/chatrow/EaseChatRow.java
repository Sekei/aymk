...
public abstract class EaseChatRow extends LinearLayout {
    ...
    public EaseChatRow(Context context, EMMessage message, int position, BaseAdapter adapter) {
        ...
        head_image = getString(context, "head_image");
        nick_name = getString(context, "nick_name");
        initView();
    }
...
//            }
            ...
            if (message.direct() == Direct.SEND) {
                ...
                Glide.with(context).load(EaseConstant.BASE_URL + head_image)
                        .transform(new GlideCircleTransform(context))
                        .into(userAvatarView);
//                usernickView.setText(nick_name);

            } else {

                Glide.with(context).load(message.getStringAttribute("from_head_image", ""))
                        .transform(new GlideCircleTransform(context))
                        .into(userAvatarView);
                // Glide.with(context).load(R.drawable.ease_chatto_bg_focused).centerCrop().into(userAvatarView);
