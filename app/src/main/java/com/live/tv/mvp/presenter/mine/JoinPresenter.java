...
public class JoinPresenter extends BasePresenter<IJoinView>{

    public JoinPresenter(App app) {
        super(app);
    }
    ...
    public void gethtmlList() {
        ...
        getAppComponent().getAPIService()
                ...
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<HttpResult<List<SystemHtmlBean>>>() {
                    ...
                    @Override
                    public void onNext(HttpResult<List<SystemHtmlBean>> userBeanHttpResult) {
                        LogUtils.d("Response:" + userBeanHttpResult);
                        if (userBeanHttpResult != null) {
                            if (isViewAttached())
                                getView().onhtmllist(userBeanHttpResult.getData());
                        }
                    }
                });
    }
