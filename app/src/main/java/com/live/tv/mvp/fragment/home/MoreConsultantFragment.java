...
public class MoreConsultantFragment extends BaseFragment<IFileMoreView, FileMorePresenter> implements IFileMoreView {
    ...
    public static MoreConsultantFragment newInstance(String type) {

        Bundle args = new Bundle();

        MoreConsultantFragment fragment = new MoreConsultantFragment();
    ...
    public void initUI() {
        ...
        adapter.setOnItemClickListener(new RecyclerArrayAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                intent.putExtra(Constants.RECORD_NAME,adapter.getItem(position).getRecord_name());
                intent.putExtra(Constants.RELATION,adapter.getItem(position).getRelation());
