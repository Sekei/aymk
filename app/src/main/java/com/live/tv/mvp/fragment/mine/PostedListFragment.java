...
public class PostedListFragment extends BaseFragment<IPostedListView, PostedListFragmentPresenter> implements IPostedListView {
    ...
    public static PostedListFragment newInstance() {
