...
public class TestResultTabPlanProfessionPresenter extends BasePresenter<ITestResultTabPlanProfessionView>{

    public TestResultTabPlanProfessionPresenter(App app) {
        super(app);
    }
    //医生列表
