...
import com.hyphenate.easeui.widget.chatrow.EaseChatRowTestData;
...
public class EaseChatTestDataPresenter extends EaseChatRowPresenter {
    private static final String TAG = "EaseChatTextPresenter";

    @Override
    protected EaseChatRow onCreateChatRow(Context cxt, EMMessage message, int position, BaseAdapter adapter) {
        return new EaseChatRowTestData(cxt, message, position, adapter);
    }
