...
public class VideoCallActivity extends CallActivity implements View.OnClickListener {
    ...
    private String consultrecordid;//咨询记录ID
...
//        recordBtn.setOnClickListener(this);
        ...
        if (!isInComingCall) {// outgoing call
            ...
            callStateTextView.setText("视频通话");
                    ...
                    case ACCEPTED: // call is accepted
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                openSpeakerOn();
                                ((TextView)findViewById(R.id.tv_is_p2p)).setText(doctor_name);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_hangup_call: // hangup
                final CustomDialog.Builder builder = new CustomDialog.Builder(VideoCallActivity.this);
...
//                callHelper.startVideoRecord(PathUtil.getInstance().getVideoPath().getAbsolutePath());
    ...
    private void Networkequest(Map<String, String> parmer, final String str) {
        ...
        ((App)VideoCallActivity.this.getApplication()).getAppCommponent().getAPIService()
                    ...
                    public void onNext(HttpResult<String> userBeanHttpResult) {
                        ...
                        if (userBeanHttpResult != null) {
                            if (!TextUtils.isEmpty(str) && str.equals("1")) {
                                ToastUtils.showToast(VideoCallActivity.this, "结束咨询");
