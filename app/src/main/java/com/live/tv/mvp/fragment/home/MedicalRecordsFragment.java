...
public class MedicalRecordsFragment extends BaseFragment<IMedicalRecordsView, MedicalRecordsPresenter> implements IMedicalRecordsView {
 ...
 /*   private MedicalListAdapter adapter;
    ...
    public static MedicalRecordsFragment newInstance(String click_type) {
...
*/
        ...
        adapter.setOnClickListener(new MedicalMonthListAdapter.OnClickListener() {
            ...
            public void onOpen(MedicalListBean medicalListBean, int pos) {
                if ("1".equals(click_type)){
                    ...
                    intent.putExtra("medical_id",medicalListBean.getMedical_id());
                    getActivity().setResult(Constants.INTENT_MEDICAL_RECORD,intent);
                    finish();
    ...
    @OnClick({R.id.ivLeft, R.id.all, R.id.tvRight})
