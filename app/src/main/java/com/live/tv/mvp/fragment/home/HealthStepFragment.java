...
public class HealthStepFragment extends BaseFragment<IHealthStepView, HealthStepPresenter> implements IHealthStepView {
    ...
    public static HealthStepFragment newInstance(String health_record_id, String doctor_id) {

        Bundle args = new Bundle();
        HealthStepFragment fragment = new HealthStepFragment();
    ...
    public void onGetHealthStage(DoctorDetailBean data) {
        ...
        if (data != null) {
            ...
            if (data.getHealthPlanBeans() != null&&data.getHealthPlanBeans().size()>0) {
                ...
                noMark.setVisibility(View.VISIBLE);
                mark.setVisibility(View.GONE);
                alreadyMark.setVisibility(View.GONE);
            }


            if (data.getIs_play_card().equals("0")){

                mark.setVisibility(View.VISIBLE);
                noMark.setVisibility(View.GONE);
                alreadyMark.setVisibility(View.GONE);
            }else {
                alreadyMark.setVisibility(View.VISIBLE);
                mark.setVisibility(View.GONE);
                noMark.setVisibility(View.GONE);
