...
public class EaseChatRowMedicalRecord extends EaseChatRow{

	private TextView contentView;

    public EaseChatRowMedicalRecord(Context context, EMMessage message, int position, BaseAdapter adapter) {
	...
	protected void onInflateView() {
		inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ?
				R.layout.ease_row_received_medical_record : R.layout.ease_row_sent_medical_record, this);
	}
