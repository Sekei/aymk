                ...
                case MSG_CALL_MAKE_VOICE:
                    try {
                        if (msg.what == MSG_CALL_MAKE_VIDEO) {
                            EMClient.getInstance().callManager().makeVideoCall(username,ext_content);
                        } else {
                            EMClient.getInstance().callManager().makeVoiceCall(username,ext_content);
                        }
