...
import com.live.tv.mvp.adapter.mine.CollectionServiceAdapter;
...
public class CollectionServiceFragment extends BaseFragment<ICollectionView,CollectionListPresenter>implements ICollectionView {
    ...
    public static CollectionServiceFragment newInstance() {
        Bundle args = new Bundle();
        CollectionServiceFragment fragment = new CollectionServiceFragment();
    ...
    public void initUI() {
        ...
        mAdapter = new CollectionServiceAdapter(context, list);
        ...
        mAdapter.setOnclick(new CollectionServiceAdapter.onclick() {
            @Override
