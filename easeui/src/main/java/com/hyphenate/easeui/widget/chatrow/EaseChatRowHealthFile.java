...
public class EaseChatRowHealthFile extends EaseChatRow{

	private TextView contentView;

    public EaseChatRowHealthFile(Context context, EMMessage message, int position, BaseAdapter adapter) {
	...
	protected void onInflateView() {
		inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ?
				R.layout.ease_row_received_health_file : R.layout.ease_row_sent_health_file, this);
	}
