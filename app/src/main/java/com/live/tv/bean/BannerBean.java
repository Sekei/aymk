...
public class BannerBean {
     ...
     * banner_type_show :
     * banner_desc : 描述
     * create_time : 2016-09-05 16:40:39.0
     * sort : 权重
     * is_delete : 0
     * banner_position : 展示位置
     * banner_position_show :
     * goods_id :
     * goods_name :
     * goods_uuid :
     * goods_class_name :
    ...
    public void setBanner_type_show(String banner_type_show) {
    ...
    public void setBanner_position_show(String banner_position_show) {
