...
import com.hyphenate.easeui.widget.chatrow.EaseChatRowHealthFile;
...
public class EaseChatHealthFilePresenter extends EaseChatRowPresenter {
    private static final String TAG = "EaseChatTextPresenter";

    @Override
    protected EaseChatRow onCreateChatRow(Context cxt, EMMessage message, int position, BaseAdapter adapter) {
        return new EaseChatRowHealthFile(cxt, message, position, adapter);
    }
