...
public class AddAddressPresenter extends BasePresenter<IAddAddressView> {
                ...
                .subscribe(new Observer<HttpResult<String>>() {
                    ...
                    public void onNext(HttpResult<String> userBeanHttpResult) {
                        ...
                        if (userBeanHttpResult != null) {
                            if (isViewAttached())
                                getView().AddAddress(userBeanHttpResult.getData());
                        }
                    }
                });
    }
 ...
 public void getUpdateAddress(Map<String, String> parmer) {
        if (isViewAttached()) {
            getView().showProgress();
        }
        getAppComponent().getAPIService()
                .UpdateAddress(parmer)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<HttpResult<String>>() {
                    ...
                    public void onNext(HttpResult<String> userBeanHttpResult) {
                        ...
                        if (userBeanHttpResult != null) {
                            if (isViewAttached())
                                getView().UpdateAddress(userBeanHttpResult.getData());
                        }
                    }
                });
    }
