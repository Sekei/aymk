...
public class EaseChatRowTestData extends EaseChatRow{

	private TextView contentView;

    public EaseChatRowTestData(Context context, EMMessage message, int position, BaseAdapter adapter) {
	...
	protected void onInflateView() {
		inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ?
				R.layout.ease_row_received_test_data : R.layout.ease_row_sent_test_data, this);
	}
