package com.live.tv.uditTextandImage;
...
public class RichTextEditor extends ScrollView {
	...
	public RichTextEditor(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		btnListener = new OnClickListener() {
			...
			public void onClick(View v) {
				if (v instanceof com.live.tv.uditTextandImage.DataImageView){
					com.live.tv.uditTextandImage.DataImageView imageView = (com.live.tv.uditTextandImage.DataImageView)v;
	 ...
	 * @param imageView
     */
	private void onImageClick(com.live.tv.uditTextandImage.DataImageView imageView) {
...
//				.start(activity);
	...
	public EditText createEditText(String hint, int paddingTop) {
		 editText = (EditText) inflater.inflate(R.layout.rich_edittext, null);
	...
	private RelativeLayout createImageLayout() {
		...
		com.live.tv.uditTextandImage.DataImageView imageView = (DataImageView) layout.findViewById(R.id.edit_imageView);
	...
	public void addEditTextAtIndex(final int index, CharSequence editStr) {
		 editText2 = createEditText("插入文字", EDIT_PADDING);
	...
	public void addImageViewAtIndex(final int index, Bitmap bmp, String imagePath) {
		...
		com.live.tv.uditTextandImage.DataImageView imageView = (com.live.tv.uditTextandImage.DataImageView) imageLayout.findViewById(R.id.edit_imageView);
...
//		}, 200);
	...
	public void addImageViewAtIndex(final int index, final String imagePath) {
		imagePaths.add(imagePath);
		RelativeLayout imageLayout = createImageLayout();
		final com.live.tv.uditTextandImage.DataImageView imageView = (com.live.tv.uditTextandImage.DataImageView) imageLayout.findViewById(R.id.edit_imageView);
		imageView.setAbsolutePath(imagePath);
...
//		mTransitioner.setDuration(300);
	...
	public List<EditData> buildEditData() {
		...
		for (int index = 0; index < num; index++) {
			...
			if (itemView instanceof EditText) {
				...
				com.live.tv.uditTextandImage.DataImageView item = (DataImageView) itemView.findViewById(R.id.edit_imageView);
	...
	public void setRtTextSize(int rtTextSize) {
		...
		if (editText2!=null){
			editText2.setTextSize(rtTextSize);
	...
	public void setRtTextColor(int rtTextColor) {
		...
		if (editText2!=null){
			editText2.setTextColor(rtTextColor);
		}
	}
