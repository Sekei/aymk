...
import com.hyphenate.easeui.widget.chatrow.EaseChatRowMedicalRecord;
...
public class EaseChatMedicalRecordPresenter extends EaseChatRowPresenter {
    private static final String TAG = "EaseChatTextPresenter";

    @Override
    protected EaseChatRow onCreateChatRow(Context cxt, EMMessage message, int position, BaseAdapter adapter) {
        return new EaseChatRowMedicalRecord(cxt, message, position, adapter);
    }
