...
public class MediaController extends FrameLayout implements IMediaController {
    ...
    private ImageView share, close, peson_gengduo;
    ...
    private PopupWindow fenxiang_pop;
    ...
    protected View makeControllerView() {
        return ((LayoutInflater) mContext
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.controller, this);
    }
    ...
    private void initControllerView(View v) {
        ...
        close.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hide();
                LivePlaybackActivity.instance.showClose();
    ...
    private void updatePausePlay() {
        ...
        if (mPlayer.isPlaying())
            mPauseButton.setImageResource(R.drawable.stop);
        else
            mPauseButton.setImageResource(R.drawable.paly);
    }
